...
public:
	...
	virtual void submitMetaball(RenderCommandType type, Material* material, const glm::vec3& pos, RenderFlag flags, const int group) override;
...
private:
	...
	std::map<int, std::vector<DXRBase::Metaball>> m_metaballs;
